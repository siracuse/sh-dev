...
<section class="project">
    <img class="project-img" src="assets/img/projects/shevent.avif" alt="sh event - projet symfony">
    <h1>SH Event</h1>
    ...
    <div class="project-description">
        ...
        <div data-aos="fade-up">
            ...
            <div class="project-description-content flex-direction-column">
                ...
                <img src="assets/img/projects/shevent-mcd.avif" alt="sh event - Modèle Conceptuel des Données" class="project-description-content">
            </div>
        </div>
        <div data-aos="fade-up">
            ...
            <div class="flex-direction-column">
                <figure class="mg-bottom-20">
                    <img src="assets/img/projects/shevent-presentation-conference.avif" alt="sh event - présentation d'une conférence" class="project-description-content">
                    <figcaption>Page de présentation d'une conférence</figcaption>
                </figure>

                <figure class="mg-bottom-20">
                    <img src="assets/img/projects/shevent-back-office.avif" alt="sh event - back office - Administration d'un événement " class="project-description-content">
